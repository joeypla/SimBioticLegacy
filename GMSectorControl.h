...
#ifndef GMSECTORCONTROL_H
#define GMSECTORCONTROL_H

#include "GameInitInfo.h"
#include "GameMode.h"
namespace ps{
	class GMSectorControl : public GameMode
	{
	public:
		GMSectorControl(const ps::GameInitInfo* gii);
		~GMSectorControl(void);
		...
		SAnimatedMesh* controlPointMeshNeutral;
